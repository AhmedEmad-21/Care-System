 ...
 * ============================================================================
 * المحتويات:
 *  - 1 حساب مدير نظام (Admin) للمرجعية وتسجيل الدخول (Care@123456)
 *  - 20 طبيب (Doctor) بـ 20 تخصص مختلف وإحداثيات دقيقة داخل محافظة الفيوم
 *  - 20 حساب مستخدم للأطباء (Users - Role: Doctor) بكلمة مرور مشفرة (Care@123456)
 *  - 20 ممرض (Nurse) بإحداثيات داخل مدن وقرى محافظة الفيوم
 *  - 20 حساب مستخدم للممرضين (Users - Role: Nurse) بكلمة مرور مشفرة (Care@123456)
 *  - 20 خدمة تمريضية منزلية (NursingService) بأسعار وتفاصيل واقعية
 *  - إنشاء فهارس الـ 2dsphere تلقائياً لضمان عمل البحث الجغرافي $nearSphere
 * ============================================================================
 */
...
(function runSeed() {
  ...
  print("🚀 بدء تشغيل اسكريبت تهيئة بيانات محافظة الفيوم...");
  ...
  // 2. قائمة الـ 20 طبيب في محافظة الفيوم
  const doctorsData = [
    {
      userId: new ObjectId("66f000000000000000000101"),
      docId: new ObjectId("66f000000000000000000201"),
    ...
    {
      userId: new ObjectId("66f000000000000000000102"),
      docId: new ObjectId("66f000000000000000000202"),
    ...
    {
      userId: new ObjectId("66f000000000000000000103"),
      docId: new ObjectId("66f000000000000000000203"),
    ...
    {
      userId: new ObjectId("66f000000000000000000104"),
      docId: new ObjectId("66f000000000000000000204"),
    ...
    {
      userId: new ObjectId("66f000000000000000000105"),
      docId: new ObjectId("66f000000000000000000205"),
    ...
    {
      userId: new ObjectId("66f000000000000000000106"),
      docId: new ObjectId("66f000000000000000000206"),
    ...
    {
      userId: new ObjectId("66f000000000000000000107"),
      docId: new ObjectId("66f000000000000000000207"),
    ...
    {
      userId: new ObjectId("66f000000000000000000108"),
      docId: new ObjectId("66f000000000000000000208"),
    ...
    {
      userId: new ObjectId("66f000000000000000000109"),
      docId: new ObjectId("66f000000000000000000209"),
    ...
    {
      userId: new ObjectId("66f000000000000000000110"),
      docId: new ObjectId("66f000000000000000000210"),
    ...
    {
      userId: new ObjectId("66f000000000000000000111"),
      docId: new ObjectId("66f000000000000000000211"),
    ...
    {
      userId: new ObjectId("66f000000000000000000112"),
      docId: new ObjectId("66f000000000000000000212"),
    ...
    {
      userId: new ObjectId("66f000000000000000000113"),
      docId: new ObjectId("66f000000000000000000213"),
    ...
    {
      userId: new ObjectId("66f000000000000000000114"),
      docId: new ObjectId("66f000000000000000000214"),
    ...
    {
      userId: new ObjectId("66f000000000000000000115"),
      docId: new ObjectId("66f000000000000000000215"),
    ...
    {
      userId: new ObjectId("66f000000000000000000116"),
      docId: new ObjectId("66f000000000000000000216"),
    ...
    {
      userId: new ObjectId("66f000000000000000000117"),
      docId: new ObjectId("66f000000000000000000217"),
    ...
    {
      userId: new ObjectId("66f000000000000000000118"),
      docId: new ObjectId("66f000000000000000000218"),
    ...
    {
      userId: new ObjectId("66f000000000000000000119"),
      docId: new ObjectId("66f000000000000000000219"),
    ...
    {
      userId: new ObjectId("66f000000000000000000120"),
      docId: new ObjectId("66f000000000000000000220"),
  ...
  doctorsData.forEach(d => {
    ...
    // إدخال أو تحديث ملف الطبيب (Doctor)
  ...
  print("✅ تم إدخال 20 طبيب + 20 حساب مستخدم في الفيوم بنجاح");

  // 3. قائمة الـ 20 ممرض في محافظة الفيوم
  const nursesData = [
    {
      userId: new ObjectId("66f000000000000000000301"),
      nurseId: new ObjectId("66f000000000000000000401"),
    ...
    {
      userId: new ObjectId("66f000000000000000000302"),
      nurseId: new ObjectId("66f000000000000000000402"),
    ...
    {
      userId: new ObjectId("66f000000000000000000303"),
      nurseId: new ObjectId("66f000000000000000000403"),
    ...
    {
      userId: new ObjectId("66f000000000000000000304"),
      nurseId: new ObjectId("66f000000000000000000404"),
    ...
    {
      userId: new ObjectId("66f000000000000000000305"),
      nurseId: new ObjectId("66f000000000000000000405"),
    ...
    {
      userId: new ObjectId("66f000000000000000000306"),
      nurseId: new ObjectId("66f000000000000000000406"),
    ...
    {
      userId: new ObjectId("66f000000000000000000307"),
      nurseId: new ObjectId("66f000000000000000000407"),
    ...
    {
      userId: new ObjectId("66f000000000000000000308"),
      nurseId: new ObjectId("66f000000000000000000408"),
    ...
    {
      userId: new ObjectId("66f000000000000000000309"),
      nurseId: new ObjectId("66f000000000000000000409"),
    ...
    {
      userId: new ObjectId("66f000000000000000000310"),
      nurseId: new ObjectId("66f000000000000000000410"),
    ...
    {
      userId: new ObjectId("66f000000000000000000311"),
      nurseId: new ObjectId("66f000000000000000000411"),
    ...
    {
      userId: new ObjectId("66f000000000000000000312"),
      nurseId: new ObjectId("66f000000000000000000412"),
    ...
    {
      userId: new ObjectId("66f000000000000000000313"),
      nurseId: new ObjectId("66f000000000000000000413"),
    ...
    {
      userId: new ObjectId("66f000000000000000000314"),
      nurseId: new ObjectId("66f000000000000000000414"),
    ...
    {
      userId: new ObjectId("66f000000000000000000315"),
      nurseId: new ObjectId("66f000000000000000000415"),
    ...
    {
      userId: new ObjectId("66f000000000000000000316"),
      nurseId: new ObjectId("66f000000000000000000416"),
    ...
    {
      userId: new ObjectId("66f000000000000000000317"),
      nurseId: new ObjectId("66f000000000000000000417"),
    ...
    {
      userId: new ObjectId("66f000000000000000000318"),
      nurseId: new ObjectId("66f000000000000000000418"),
    ...
    {
      userId: new ObjectId("66f000000000000000000319"),
      nurseId: new ObjectId("66f000000000000000000419"),
    ...
    {
      userId: new ObjectId("66f000000000000000000320"),
      nurseId: new ObjectId("66f000000000000000000420"),
  ...
  nursesData.forEach(n => {
    ...
    // إدخال أو تحديث ملف الممرض (Nurse)
    db.nurses.updateOne(
      { _id: n.nurseId },
      {
        $set: {
  ...
  print("✅ تم إدخال 20 ممرض + 20 حساب مستخدم في الفيوم بنجاح");

  // 4. قائمة الـ 20 خدمة تمريضية منزلية (NursingServices)
  const nursingServicesData = [
    {
      _id: new ObjectId("66f000000000000000000501"),
    ...
    {
      _id: new ObjectId("66f000000000000000000502"),
    ...
    {
      _id: new ObjectId("66f000000000000000000503"),
    ...
    {
      _id: new ObjectId("66f000000000000000000504"),
    ...
    {
      _id: new ObjectId("66f000000000000000000505"),
    ...
    {
      _id: new ObjectId("66f000000000000000000506"),
    ...
    {
      _id: new ObjectId("66f000000000000000000507"),
    ...
    {
      _id: new ObjectId("66f000000000000000000508"),
    ...
    {
      _id: new ObjectId("66f000000000000000000509"),
    ...
    {
      _id: new ObjectId("66f000000000000000000510"),
    ...
    {
      _id: new ObjectId("66f000000000000000000511"),
    ...
    {
      _id: new ObjectId("66f000000000000000000512"),
    ...
    {
      _id: new ObjectId("66f000000000000000000513"),
    ...
    {
      _id: new ObjectId("66f000000000000000000514"),
    ...
    {
      _id: new ObjectId("66f000000000000000000515"),
    ...
    {
      _id: new ObjectId("66f000000000000000000516"),
    ...
    {
      _id: new ObjectId("66f000000000000000000517"),
    ...
    {
      _id: new ObjectId("66f000000000000000000518"),
    ...
    {
      _id: new ObjectId("66f000000000000000000519"),
    ...
    {
      _id: new ObjectId("66f000000000000000000520"),
  ...
  print("✅ تم إدخال 20 خدمة تمريضية بنجاح");

  // 5. ضبط الفهارس الجغرافية (2dsphere Indexes) لضمان دقة البحث الجغرافي
  try {
    ...
    print("✅ تم التأكد من إنشاء فهارس 2dsphere للبحث الجغرافي بنجاح");
  } catch (e) {
    print("⚠️ ملاحظة حول الفهارس: " + e.message);
  }

  print("\n=======================================================");
  print("🎉 تم اكتمال إدخال البيانات بنجاح!");
  print("📍 الإحصائيات:");
  print("   - الأطباء: " + db.doctors.countDocuments());
  print("   - الممرضين: " + db.nurses.countDocuments());
